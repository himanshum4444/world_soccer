          ...
          <div class="query">
            <form method= "get" action="">
              <fieldset>
                ...
                <input type="text" id="homestadium" name="homestadium" value="<?php if(isset($_GET['homestadium'])) echo htmlspecialchars($_GET['homestadium']); else echo "";?>">

                <label for="league">League</label>
                <select id="league" name="league" value="<?php if(isset($_GET['league'])) echo htmlspecialchars($_GET['league']); else echo "";?>">
                  <option value=""></option>
                ...
                <input type="text" id="playername" name="playername" value="<?php if(isset($_GET['playername'])) echo htmlspecialchars($_GET['playername']); else echo "";?>"><hr>
        ...
        <div class="col-xs-12 col-lg-9">
          ...
          <div class="jumbotron">
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $AddClubName = isset($_REQUEST['AddClubName'])?trim($_REQUEST['AddClubName']):'';
                  $AddClubCountry = isset($_REQUEST['AddClubCountry'])?trim($_REQUEST['AddClubCountry']):'';
                  $AddClubLeague = isset($_REQUEST['AddClubLeague'])?trim($_REQUEST['AddClubLeague']):'';
                  $AddHomeStadium = isset($_REQUEST['AddHomeStadium'])?trim($_REQUEST['AddHomeStadium']):'';
              ...
              <fieldset>
                ...
                <input type="text" id="addclubname" name="AddClubName" value="<?php if(isset($_GET['clubname'])) echo htmlspecialchars($_GET['clubname']); else echo "";?>">

                <label for="lcountry">Country</label>
                <input type="text" id="countryname" name="AddClubCountry" value="<?php if(isset($_GET['clubname'])) echo htmlspecialchars($_GET['clubname']); else echo "";?>">

                <label for="lstadium">Home Stadium</label>
                <input type="text" id="stadiumname" name="AddHomeStadium" value="<?php if(isset($_GET['clubname'])) echo htmlspecialchars($_GET['clubname']); else echo "";?>">

                <label for="position">League</label>
                <select id="position" name="AddClubLeague" value="<?php if(isset($_GET['clubname'])) echo htmlspecialchars($_GET['clubname']); else echo "";?>">
                  <option value=""></option>
                  <option value="Premier League">Premier League</option>
                  <option value="La Liga">La Liga</option>
                  <option value="Bundesliga">Bundesliga</option>
            ...
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $UpdateClubName = isset($_REQUEST['UpdateClubName'])?trim($_REQUEST['UpdateClubName']):'';
                  $UpdateClubCountry = isset($_REQUEST['UpdateClubCountry'])?trim($_REQUEST['UpdateClubCountry']):'';
                  $UpdateHomeStadium = isset($_REQUEST['UpdateHomeStadium'])?trim($_REQUEST['UpdateHomeStadium']):'';
                  $UpdateClubLeague = isset($_REQUEST['UpdateClubLeague'])?trim($_REQUEST['UpdateClubLeague']):'';
              ...
              <fieldset>
                ...
                <input type="text" id="updateclubname" name="UpdateClubName" value="<?php if(isset($_GET['UpdateClubName'])) echo htmlspecialchars($_GET['UpdateClubName']); else echo "";?>">
                <br>

                <legend>Enter the attribute value that you want to update:</legend>
                <label for="lcountry">Country </label>
                <input type="text" id="updatecountryname" name="UpdateClubCountry" value="<?php if(isset($_GET['UpdateClubCountry'])) echo htmlspecialchars($_GET['UpdateClubCountry']); else echo "";?>">

                <label for="lstadium">Home Stadium</label>
                <input type="text" id="stadiumname" name="UpdateHomeStadium" value="<?php if(isset($_GET['UpdateHomeStadium'])) echo htmlspecialchars($_GET['UpdateHomeStadium']); else echo "";?>">

                <label for="position">League</label>
                <select id="updateposition" name="UpdateClubLeague" value="<?php if(isset($_GET['UpdateClubLeague'])) echo htmlspecialchars($_GET['UpdateClubLeague']); else echo "";?>">
                  <option value=""></option>
                  <option value="Premier League">Premier League</option>
                  <option value="La Liga">La Liga</option>
                  <option value="Bundesliga">Bundesliga</option>
            ...
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $DeleteClubName = isset($_REQUEST['DeleteClubName'])?trim($_REQUEST['DeleteClubName']):'';
              ...
              <fieldset>
                ...
                <input type="text" id="deleteclubname" name="DeleteClubName" value="<?php if(isset($_GET['DeleteClubName'])) echo htmlspecialchars($_GET['DeleteClubName']); else echo "";?>">
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <form method="get" action="">
                ...
                $homestadium = isset($_REQUEST['homestadium'])?trim($_REQUEST['homestadium']):'';
                $league = isset($_REQUEST['league'])?trim($_REQUEST['league']):'';
