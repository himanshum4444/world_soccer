          ...
          <div class="query">
            <form method= "get" action="">
              <fieldset>
                ...
                <input type="text" id="countryname" name="playercountry" value="<?php if(isset($_GET['playercountry'])) echo htmlspecialchars($_GET['playercountry']); else echo "";?>">
                ...
                <input type="text" id="lminage" name="playerminage" value="<?php if(isset($_GET['playerminage'])) echo htmlspecialchars($_GET['playerminage']); else echo "";?>">

                <label for="lmaxage">Maximum Age (<=)</label>
                <input type="text" id="lmax" name="playermaxage" value="<?php if(isset($_GET['playermaxage'])) echo htmlspecialchars($_GET['playermaxage']); else echo "";?>">
        ...
        <div class="col-xs-12 col-lg-9">
          ...
          <div class="jumbotron">
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $PlayerName = isset($_REQUEST['PlayerName'])?(String)trim($_REQUEST['PlayerName']):'';
                  $PlayerCountry = isset($_REQUEST['PlayerCountry'])?(String)trim($_REQUEST['PlayerCountry']):'';
                  $PlayerPosition = isset($_REQUEST['PlayerPosition'])?(String)trim($_REQUEST['PlayerPosition']):'';
                  $PlayerAge = isset($_REQUEST['PlayerAge'])?(int)trim($_REQUEST['PlayerAge']):0;
            ...
            <form method= "post" action="">
              <?php
                  ...
                  $UpdatePlayerPosition = isset($_REQUEST['UpdatePlayerPosition'])?(String)trim($_REQUEST['UpdatePlayerPosition']):'';
                  $UpdatePlayerAge = isset($_REQUEST['UpdatePlayerAge'])?(int)trim($_REQUEST['UpdatePlayerAge']):'0';
              ...
              <fieldset>
                ...
                <input type="text" id="updateplayername" name="UpdatePlayerName" value="<?php if(isset($_GET['UpdatePlayerName'])) echo htmlspecialchars($_GET['UpdatePlayerName']); else echo '';?>">
                <br>

                <legend>Enter the attribute value that you want to update:</legend>
                <label for="lcountry">Country (Ex: Spain)</label>
                <input type="text" id="updatecountryname" name="UpdatePlayerCountry" value="<?php if(isset($_GET['UpdatePlayerName'])) echo htmlspecialchars($_GET['UpdatePlayerName']); else echo '';?>">
            ...
            <form method= "post" action="">
              ...
              <fieldset>
                ...
                <input type="text" id="deleteplayername" name="DeletePlayerName" value="<?php if(isset($_GET['DeletePlayerName'])) echo htmlspecialchars($_GET['DeletePlayerName']); else echo '';?>">
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <form method="get" action="">
                ...
                $playercountry = isset($_REQUEST['playercountry'])?trim($_REQUEST['playercountry']):'';
                ...
                $playerminage = isset($_REQUEST['playerminage'])?trim($_REQUEST['playerminage']):0;
                $playermaxage = isset($_REQUEST['playermaxage'])?trim($_REQUEST['playermaxage']):100;
