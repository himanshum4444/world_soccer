          ...
          <div class="query">
            <form method= "get" action="">
              <fieldset>
                ...
                <input type="text" id="managername" name="managername" value="<?php if(isset($_GET['managername'])) echo htmlspecialchars($_GET['managername']); else echo '';?>">

                <label for="lcountry">Country (Ex: England)</label>
                <input type="text" id="countryname" name="managercountry" value="<?php if(isset($_GET['managercountry'])) echo htmlspecialchars($_GET['managercountry']); else echo '';?>">

                <label for="lmanagername">Managed which player (Ex: Raheem Sterling)</label>
                <input type="text" id="playername" name="playername" value="<?php if(isset($_GET['playername'])) echo htmlspecialchars($_GET['playername']); else echo '';?>">

                <label for="lclubname">Manages for which club (Ex: Manchester City)</label>
                <input type="text" id="clubname" name="clubname" value="<?php if(isset($_GET['clubname'])) echo htmlspecialchars($_GET['clubname']); else echo '';?>"><hr>

                <label for="lage">For one age value, enter same value:</label>
                <label for="lminage">Minimum Age (>=)</label>
                <input type="text" id="lminage" name="managerminage" value="<?php if(isset($_GET['managerminage'])) echo htmlspecialchars($_GET['managerminage']); else echo '';?>">

                <label for="lmaxage">Maximum Age (<=)</label>
                <input type="text" id="lmax" name="managermaxage" value="<?php if(isset($_GET['managermaxage'])) echo htmlspecialchars($_GET['managermaxage']); else echo '';?>">
        ...
        <div class="col-xs-12 col-lg-9">
          ...
          <div class="jumbotron">
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $AddManagerName = isset($_REQUEST['AddManagerName'])?(String)trim($_REQUEST['AddManagerName']):'';
                  $AddManagerCountry = isset($_REQUEST['AddManagerCountry'])?(String)trim($_REQUEST['AddManagerCountry']):'';
                  $AddManagerAge = isset($_REQUEST['AddManagerAge'])?(int)trim($_REQUEST['AddManagerAge']):0;
              ...
              <fieldset>
                ...
                <input type="text" id="managername" name="AddManagerName" value="<?php if(isset($_GET['AddManagerName'])) echo htmlspecialchars($_GET['AddManagerName']); else echo '';?>">

                <label for="lcountry">Country</label>
                <input type="text" id="countryname" name="AddManagerCountry" value="<?php if(isset($_GET['AddManagerCountry'])) echo htmlspecialchars($_GET['AddManagerCountry']); else echo '';?>">

                <label for="age">Age</label>
                <input type="number" id="age" name="AddManagerAge" value="<?php if(isset($_GET['AddManagerAge'])) echo htmlspecialchars($_GET['AddManagerAge']); else echo '';?>">
            ...
            <form method= "post" action="">
              <?php
                  ...
                  $UpdateManagerName = isset($_REQUEST['UpdateManagerName'])?(String)trim($_REQUEST['UpdateManagerName']):'';
                  $UpdateManagerCountry = isset($_REQUEST['UpdateManagerCountry'])?(String)trim($_REQUEST['UpdateManagerCountry']):'';
                  $UpdateManagerAge = isset($_REQUEST['UpdateManagerAge'])?(int)trim($_REQUEST['UpdateManagerAge']):'0';
              ...
              <fieldset>
                ...
                <input type="text" id="updatemanagername" name="UpdateManagerName" value="<?php if(isset($_GET['UpdateManagerName'])) echo htmlspecialchars($_GET['UpdateManagerName']); else echo '';?>">
                <br>

                <legend>Enter the attribute value that you want to update:</legend>
                <label for="lcountry">Country</label>
                <input type="text" id="updatecountryname" name="UpdateManagerCountry" value="<?php if(isset($_GET['UpdateManagerCountry'])) echo htmlspecialchars($_GET['UpdateManagerCountry']); else echo '';?>">

                <label for="age">Age</label>
                <input type="number" id="updatemanagerage" name="UpdateManagerAge" value="<?php if(isset($_GET['UpdateManagerAge'])) echo htmlspecialchars($_GET['UpdateManagerAge']); else echo '';?>">
            ...
            <form method= "post" action="">
              <?php
                  include 'inc/connection.php';
                  $DeleteManagerName = isset($_REQUEST['DeleteManagerName'])?(String)trim($_REQUEST['DeleteManagerName']):'';
              ...
              <fieldset>
                ...
                <input type="text" id="deletemanagername" name="DeleteManagerName" value="<?php if(isset($_GET['DeleteManagerName'])) echo htmlspecialchars($_GET['DeleteManagerName']); else echo '';?>">
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <form method="get" action="">
                ...
                $managername = isset($_REQUEST['managername'])?trim($_REQUEST['managername']):'';
                $managercountry = isset($_REQUEST['managercountry'])?trim($_REQUEST['managercountry']):'';
                $playername = isset($_REQUEST['playername'])?trim($_REQUEST['playername']):'';
                $clubname = isset($_REQUEST['clubname'])?trim($_REQUEST['clubname']):'';
                $managerminage = isset($_REQUEST['managerminage'])?trim($_REQUEST['managerminage']):'';
                $managermaxage = isset($_REQUEST['managermaxage'])?trim($_REQUEST['managermaxage']):'';
